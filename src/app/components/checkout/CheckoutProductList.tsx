...
const CheckoutProductList = () => {
	...
	return (
		<div>
			<div className="w-full my-2 py-2 overflow-auto bg-white flex-grow max-h-[365px] lg:max-h-[530px] lg:scrollbar-thin lg:scrollbar-thumb-gbCustomScrollThumbColor lg:scrollbar-track-[#FEF3E9]">
